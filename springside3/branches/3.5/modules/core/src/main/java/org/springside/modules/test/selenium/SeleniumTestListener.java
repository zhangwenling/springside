 ...
 * 
 * $Id: SeleniumTestListener.java 764 2009-12-27 19:13:59Z calvinxiu $
 */
...
public class SeleniumTestListener extends RunListener {
	...
	public void testFailure(Failure failure) {
		...
		try {
			...
			System.err.println("Saved screenshot to " + imgFilePath);//NOSONAR
		} catch (Exception e) {
			System.err.println("Couldn't save screenshot to " + imgFilePath + ": " + e.getMessage());//NOSONAR
		}
	}
}
