...
public class SubjectDao extends HibernateDao<Subject, Long> {
	...
	public static final String QUERY_WITH_DETAIL_AND_REPLY = "from Subject s fetch all properties left join fetch s.replyList fetch all properties where s.id=?";
