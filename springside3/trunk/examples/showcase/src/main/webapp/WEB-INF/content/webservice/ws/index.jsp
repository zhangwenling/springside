	...
	<div id="yui-main">
		...
		<ul>
			<li>Plain式密码, 传输时安全度较低, 但不要求服务端必须保存有客户密码的明文.<br/>
				WSDL: <a href="http://localhost:9090/showcase/services/UserServiceWithPlainPassword?wsdl">http://localhost:9090/showcase/services/UserServiceWithPlainPassword?wsdl</a>
			</li>
			<li>Digest式密码, 传输时较为安全, 但要求服务端必须保存有密码的明文.<br/>
				WSDL: <a href="http://localhost:9090/showcase/services/UserServiceWithDigestPassword?wsdl">http://localhost:9090/showcase/services/UserServiceWithDigestPassword?wsdl</a>
			</li>
