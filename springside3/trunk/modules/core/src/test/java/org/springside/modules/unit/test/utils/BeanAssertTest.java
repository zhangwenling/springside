...
import org.springside.modules.test.utils.BeanAssert;
import org.springside.modules.test.utils.BeanDefaultValueUtils;
import org.springside.modules.unit.test.utils.testbean.Bean1;
import org.springside.modules.unit.test.utils.testbean.CommentBean;
...
public class BeanAssertTest extends TestCase {
	...
	public void test3_ignore_properties() {
		...
		try {
			...
			assertTrue(e.getMessage(),e.getMessage().contains("[CommentBean.password] must be not null"));
		}
	}
