...
if "%ACTIVEMQ_OPTS%" == "" set ACTIVEMQ_OPTS=-Xms2048M -Xmx2048M -Xmn682M -Dorg.apache.activemq.UseDedicatedTaskRunner=true -Djava.util.logging.config.file=logging.properties
