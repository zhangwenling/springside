...
import ${package}.service.user.RoleManager;
...
@Results( { @Result(name = CRUDActionSupport.RELOAD, location = "user.action?page.pageRequest=${symbol_dollar}{page.pageRequest}", type = "redirect") })
